...
const App = () => {
  ...
  const heroImages = [
    {
      url: "https://www.primor.eu/blog/wp-content/uploads/2023/08/MARCA-PERF-H-1200x675.jpg",
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
              ...
              <div className="bg-white p-6 sm:p-8 rounded-2xl shadow-2xl text-center transition-all duration-300 hover:shadow-purple-500/25 hover:-translate-y-2 border border-purple-200">
                ...
                <div className="flex justify-center space-x-4 mt-4 sm:mt-6">
                  <img
                      src="https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?q=80&w=100&auto=format&fit=crop&ixlib=rb-4.0.3"
                      alt="Splash"
                      className="w-16 sm:w-24 h-16 sm:h-24 object-cover rounded-xl shadow-lg"
                  />
                  <img
                      src="https://images.unsplash.com/photo-1594736797933-d0589ba40a68?q=80&w=100&auto=format&fit=crop&ixlib=rb-4.0.3"
                      alt="Splash"
                      className="w-16 sm:w-24 h-16 sm:h-24 object-cover rounded-xl shadow-lg"
                  />
                </div>
